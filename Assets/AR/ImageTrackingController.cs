...
// nayarbP, Controlador de seguimiento QR para la escena AR del Buen Samaritano, sin nuevas variables, 2026-07-20
...
public class ImageTrackingController : MonoBehaviour
{
    ...
    // nayarbP, Eventos estaticos para notificar deteccion y perdida del marcador QR, sin nuevas variables, 2026-07-20
    ...
    private void Awake()
    {
        ...
        // nayarbP, Inicializa el manager de imagenes rastreadas y reutiliza el prefab del manager si no hay uno asignado, sin nuevas variables, 2026-07-20
    ...
    // nayarbP, Registra el listener de cambios en imagenes rastreadas al activarse el componente, sin nuevas variables, 2026-07-03
    ...
    // nayarbP, Elimina el listener de tracking al desactivarse el componente, sin nuevas variables, 2026-07-03
    ...
    // nayarbP, Procesa imagenes QR agregadas, actualizadas o removidas para mostrar u ocultar la escena AR, sin nuevas variables, 2026-07-20
    ...
    // nayarbP, Instancia y ancla el contenido AR al marcador detectado, sin nuevas variables, 2026-07-20
